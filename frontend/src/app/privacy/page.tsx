    ...
    <div className="min-h-screen bg-[var(--surface-base)] text-zinc-300 py-16 px-6 font-sans">
      <div className="max-w-2xl mx-auto">
        ...
        <header className="mb-10 pb-8 border-b border-white/[0.08]">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight leading-tight">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-sm leading-relaxed text-zinc-400">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-white">3. Cookies and Analytics</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-white">5. Contact Support</h2>
            <p>
