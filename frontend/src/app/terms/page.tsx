      ...
      <div className="max-w-2xl mx-auto">
        ...
        <header className="mb-10 pb-8 border-b border-white/[0.08]">
          <div className="flex items-center gap-2.5 mb-4">
            ...
            <span className="text-sm font-semibold text-white font-mono tracking-tight">RIVALSCOPE</span>
          </div>
          <h1 className="text-3xl font-bold text-white tracking-tight leading-tight">Terms of Service</h1>
          <p className="text-xs text-zinc-500 font-mono mt-2">Last updated: June 7, 2026</p>
        </header>
        ...
        <div className="space-y-8 text-sm leading-relaxed text-zinc-400">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-white">2. Scope of Service</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-white">3. Acceptable Use Policy</h2>
            <p>
