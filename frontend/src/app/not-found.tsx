    ...
    <div className="min-h-screen bg-[var(--surface-base)] text-[var(--text-primary)] flex items-center px-6 font-sans">
      <div className="max-w-md mx-auto w-full">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 text-sm font-semibold px-4 py-3 rounded-md bg-[var(--accent-cta)] text-[var(--accent-text)] hover:bg-[var(--accent-hover)] transition-colors"
          >
            <LayoutDashboard size={15} /> Back to dashboard
          </Link>
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm font-semibold px-4 py-3 rounded-md border border-[var(--border-default)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[var(--border-strong)] transition-colors"
          >
